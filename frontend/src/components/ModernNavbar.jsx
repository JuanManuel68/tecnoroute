...
const ModernNavbar = () => {
  ...
  const menuCategories = {
    ...
    orders: { label: 'Pedidos', items: menuItems.filter(item => item.category === 'orders') },
    users: { label: 'Usuarios', items: menuItems.filter(item => item.category === 'users') },
    logistics: { label: 'Logística', items: menuItems.filter(item => item.category === 'logistics') }
  };
